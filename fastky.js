(function () {
    ...
    const STORAGE_KEY = "fb_period_selection_v2";
    ...
    function setDateRange(startDate, endDate) {
        ...
        if (!startInput || !endInput) return alert("Không tìm thấy input ngày!");
    ...
    function openDialog() {
        ...
        dialog.innerHTML = `<h2 style="margin-top:0">Chọn kỳ báo cáo</h2>`;
